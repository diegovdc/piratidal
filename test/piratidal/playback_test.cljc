...
(deftest get-event-onset-time-test
  #_(is (= [1875.0 2000.0 2125.0 2250.0 2375.0 2500.0]
           (mapv float
  ...
  #_(testing "Supports changes in cps"
  ...
  (testing "Supports changes in cps"
    (is (= [2000.0 2250.0 2500.0 2750.0]
           (mapv float
                 [(get-event-onset-time 2 1 1500 2000 1 1)
                  (get-event-onset-time 2 1 1500 2000 1 3/2)
                  (get-event-onset-time 2 1 2000 2500 2 2)
                  (get-event-onset-time 2 1 2000 2500 2 5/2)])))))
