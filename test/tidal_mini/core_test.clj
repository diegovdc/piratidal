  ...
  (let [pat->schedule (fn [pattern cycles]
    ...
    (testing ""
      ...
      (testing "`:slow`"
        ...
        (is (= [{:event {:word "a"}, :arc [0 1], :cycle 0}]
        ...
        (is (= [{:event {:word "a"}, :arc [0 1/2], :cycle 0}
                {:event {:word "c"}, :arc [1/2 1N], :cycle 0}
                {:event {:word "b"}, :arc [1/4 1/2], :cycle 1}
                {:event {:word "c"}, :arc [1/2 1N], :cycle 1}
                {:event {:word "c"}, :arc [1/2 1N], :cycle 2}]
        ...
        (is (= [{:event {:word "c"}, :arc [0 1/2], :cycle 0}
                ...
                {:event {:word "a"}, :arc [1/2 1N], :cycle 3}
                {:event {:word "c"}, :arc [0 1/2], :cycle 4}
                {:event {:word "b"}, :arc [3/4 1N], :cycle 4}
        ...
        (let [pat->schedule2 (fn [pattern cycles]
          ...
          (testing "gain"
            ...
            (is (= [{:event {:word "bd"}, :arc [0 2/3], :cycle 0, :gain 1}
                    {:event {:word "hh"}, :arc [2/3 1], :cycle 0, :gain 2}
          ...
          (testing "note"
            (is (= [{:event {:word "bd"}, :arc [0 2/3], :cycle 0, :note 1}
                    {:event {:word "hh"}, :arc [2/3 1], :cycle 0, :note 2}
